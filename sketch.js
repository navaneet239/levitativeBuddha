...
function draw() {
  ...
  text("Levitation height scale", width - 180, 85, fill("black"),textSize(15))

  text("0m -", width - 175, 280, fill("white"),textSize(17))

  text("-", width - 146.75, 260, fill("white"),textSize(17))

  text("25m -", width - 185, 240, fill("white"),textSize(17))

  text("-", width - 146.75, 220, fill("white"),textSize(17))

  text("50m -", width - 185, 200, fill("white"),textSize(17))

  text("-", width - 146.75, 180, fill("white"),textSize(17))

  text("75m -", width - 185, 160, fill("white"),textSize(17))

  text("-", width - 146.75, 140, fill("white"),textSize(17))
